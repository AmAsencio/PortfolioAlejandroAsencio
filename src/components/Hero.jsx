            ...
            <div className="max-w-6xl mx-auto w-full">
                <div className="flex flex-col md:flex-row items-center gap-12">
                    ...
                    <div className="relative">
                        ...
                        {/* Badge de ubicación */}
                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2 bg-gradient-to-r from-yellow-400 to-orange-500 text-gray-900 px-3 py-1 sm:px-4 sm:py-1.5 rounded-full font-bold text-xs sm:text-sm shadow-xl whitespace-nowrap flex items-center gap-1.5">
                    ...
                    <div className="flex-1 text-center md:text-left">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center md:justify-start">
                            {/* LinkedIn */}
                            <a
                                href="https://www.linkedin.com/in/alejandro-asencio-montes-96973a282/"
                                target="_blank"
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex items-center gap-2 px-6 py-3 bg-gray-800 text-white rounded-lg hover:bg-gray-900 transition font-medium"
                            >
                                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                            ...
                            <a
                                href="/AlejandroAsencioCarta.pdf"
                            ...
                            {/* CV */}
                            <a
                                href="/AlejandroAsencioFullstack.pdf"
